...
- [[PdfRenderer.render()]] - `contains` [EXTRACTED]
- [[PdfRenderer.render_with_status()]] - `contains` [EXTRACTED]
- [[ReportCli.__init__()]] - `calls` [INFERRED]
- [[pdf.py]] - `contains` [EXTRACTED]
- [[test_pdf_renderer_injects_print_layout_override_for_composed_reports()]] - `calls` [INFERRED]
