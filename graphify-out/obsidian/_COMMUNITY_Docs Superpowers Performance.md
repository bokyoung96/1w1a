...
```dataview
TABLE source_file, type FROM #community/Docs_Superpowers_Performance
SORT file.name ASC
```

## Connections to other communities
- 22 edges to [[_COMMUNITY_Docs Superpowers Reporting]]
- 14 edges to [[_COMMUNITY_Backtesting Reporting Frontend]]
- 8 edges to [[_COMMUNITY_Docs Superpowers Kosdaq150]]
- 6 edges to [[_COMMUNITY_Docs Superpowers Analytics]]
- 6 edges to [[_COMMUNITY_Backtesting Reporting Composers]]
- 6 edges to [[_COMMUNITY_Docs Superpowers Plans]]
- 5 edges to [[_COMMUNITY_Docs Superpowers Research]]
- 4 edges to [[_COMMUNITY_Tests Test Run.Py Engine]]
...
## Top bridge nodes
- [[2026-04-03-performance-reporting-redesign-design]] - degree 131, connects to 23 communities