...
## Connections
- [[BacktestEngine._cap_buy_delta()]] - `calls` [INFERRED]
- [[BacktestRunner._trim_plan_to_display_range()]] - `calls` [INFERRED]
- [[DataTools.to_frame()]] - `calls` [INFERRED]
- [[LaunchResolutionService._is_usable_saved_run()]] - `calls` [INFERRED]
- [[PerformanceSnapshotFactory._latest_rebalance_date()]] - `calls` [INFERRED]
- [[RunIndexService._is_usable_run_dir()]] - `calls` [INFERRED]
...
- [[test_quantile_returns_drops_duplicate_signals_without_error()]] - `calls` [INFERRED]
